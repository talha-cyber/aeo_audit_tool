...
def upgrade() -> None:
    ...
    op.add_column(
        "questions", sa.Column("provider_version", sa.String(), nullable=True)
    )
    ...
    op.add_column(
        "questions", sa.Column("emotional_anchor", sa.String(), nullable=True)
    )
    ...
    op.add_column(
        "responses", sa.Column("emotional_satisfaction", sa.String(), nullable=True)
    )
    op.add_column(
        "responses", sa.Column("satisfaction_score", sa.Float(), nullable=True)
    )
    op.add_column(
        "responses", sa.Column("satisfaction_model", sa.String(), nullable=True)
    )
